...
#include <memory>
#include "../mapProject/markermodel.h"
...
QT_MOC_LITERAL(4, 36, 14) // "QGeoCoordinate"

    },
    "MarkerModel\0currentChanged\0\0current\0"
    "QGeoCoordinate"
};
...
void MarkerModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MarkerModel::currentChanged)) {
                *result = 0;
                return;
            }
        }
